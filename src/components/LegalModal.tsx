            ...
            <div className="relative w-full max-w-2xl bg-[#0a0a0a] border border-white/10 rounded-[6px] overflow-hidden shadow-2xl flex flex-col max-h-[85vh] animate-scale-in">
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-12 custom-scrollbar">
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-4 text-[11px] text-white/50 leading-relaxed font-mono">
                            <p>We collect artist/gallery names, URLs, and a required contact email via the application form. If approved, your artist/gallery name and URL are made public. Contact emails are kept in private server-side storage and are never publicly displayed.</p>
                            <div className="space-y-2">
                                <span className="text-white uppercase font-bold tracking-widest text-[9px]">Email Usage</span>
                                <p>We use your email solely to communicate about your submission status and send occasional platform updates. We do not sell, trade, or publish contact emails.</p>
                            </div>
                            <div className="space-y-2">
