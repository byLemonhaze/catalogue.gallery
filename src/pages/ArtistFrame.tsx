            ...
            >
                ...
                >
                    <Link
                        ...
                        className="px-4 py-2 bg-[#0c0c0c] text-[10px] font-bold uppercase tracking-[0.2em] text-white/60 hover:text-white border border-white/10 hover:border-white/25 transition-colors flex items-center gap-2"
                    >
                        <span>Exit ✕</span>
                    </Link>
                </div>
