...
Catalogue.gallery helps collectors discover new artists without flattening them into a single marketplace. Instead of hosting artwork, it sends viewers directly into each artist's own website and self-curated world, while also surfacing galleries and platforms that shape discovery around them.
