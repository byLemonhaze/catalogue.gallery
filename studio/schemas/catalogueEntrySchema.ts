...
interface CatalogueSchemaCopy {
    subtitleDescription: string
    contentBioDescription: string
}

interface CatalogueSchemaOptions extends CatalogueSchemaCopy {
    name: 'artist' | 'gallery'
    title: 'Artist' | 'Gallery'
}

function buildWebsiteUrlValidation(Rule: any) {
    return Rule.required().custom(async (value: string, context: any) => {
...
function buildSharedFields({ subtitleDescription, contentBioDescription }: CatalogueSchemaCopy) {
    return [
        {
            name: 'name',
            title: 'Name',
        ...
        },
        {
            ...
            title: 'Website URL',
            type: 'url',
            validation: buildWebsiteUrlValidation,
        },
        {
            name: 'contactId',
        ...
        },
        {
            ...
            type: 'text',
            rows: 8,
            description: contentBioDescription,
        },
        {
...
export function createCatalogueEntrySchema({
    name,
    title,
    subtitleDescription,
    contentBioDescription,
}: CatalogueSchemaOptions) {
    return {
        name,
        title,
        type: 'document',
