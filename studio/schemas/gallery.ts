...
export default {
    ...
    fields: [
        ...
        },
        {
            ...
            title: 'Subtitle',
            type: 'string',
            description: 'Short snippet, e.g. "Verse, Sovrn, Art Blocks etc."',
        },
        ...
        },
        {
            ...
            type: 'text',
            rows: 8,
            description: 'Auto-generated from website. Used by Content Lab as primary source for article/blog generation. Can be manually curated.',
        },
        {
